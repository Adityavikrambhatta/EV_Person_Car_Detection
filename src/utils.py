...
def create_train_val_split(dataset_dir, output_dir, split_ratio=0.8):
    """
    Split images from dataset_dir into training and validation sets and save them in separate folders.

    Parameters:
    - dataset_dir: str, directory containing images to be split.
    - output_dir: str, base directory where train/val folders will be created.
    - split_ratio: float, percentage of images to be used for training (default 0.8).
    """
